...
@pytest.mark.parametrize(
    ...
    [
        (
            molpot.elec.metatensor.Calculator,
            {
                "potential": molpot.elec.CoulombPotential(smearing=None),
            },
        ),
        (
            molpot.elec.metatensor.EwaldCalculator,
            {
                "potential": molpot.elec.CoulombPotential(smearing=SMEARING),
                "lr_wavelength": LR_WAVELENGTH,
            },
        ),
        (
            molpot.elec.metatensor.PMECalculator,
            {
                "potential": molpot.elec.CoulombPotential(smearing=SMEARING),
        ...
        (
            molpot.elec.metatensor.P3MCalculator,
            {
                "potential": molpot.elec.CoulombPotential(smearing=SMEARING),
                "mesh_spacing": MESH_SPACING,
            },
