...
import molpot.elec
import molpot.elec.calculators
...
class CalculatorTestTorch(molpot.elec.Calculator):
    def __init__(self, potential=None):
        super().__init__(
            potential=potential
            or molpot.elec.CoulombPotential(smearing=None, exclusion_radius=None)
        )


class CalculatorTest(molpot.elec.metatensor.Calculator):
    _base_calculator = CalculatorTestTorch

    def __init__(self):
        super().__init__(potential=molpot.elec.CoulombPotential(smearing=None))
